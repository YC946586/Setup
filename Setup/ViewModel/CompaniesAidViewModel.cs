...
{
    public class CompaniesAidViewModel : ViewModelBase
    {
        ...
        public CompaniesAidViewModel()
        {
            ...
            if (drive.Length != 0)
            {
                ...
                if (driveDate.Any())
                {
                    ...
                    {
                        PageCollection.StrupPath = driveDate[1].Name + "CompaniesAid";
                    }
                    else
                    {
                        PageCollection.StrupPath = driveDate[0].Name + "CompaniesAid";
                    }
                }
            }
            //操作系统
        ...
        private void Browse()
        {
            try
            {
                ...
                {
                    PageCollection.StrupPath = fbd.SelectedPath + "\\CompaniesAid";
                }
            }
            catch (Exception ex)
            {
        ...
        private void Adddesktop()
        {
            try
            {
                ...
                //删除注册表数据
                Tool.DeleteStartMenuShortcuts(ProcessBase.Companies, PageCollection.StrupPath);
                ...
                if (hkeyCurrentUser != null)
                {
                    ...
                    Tool.CreateShortcut(programsPath + @"\四川橘子智税科技有限公司\企助.lnk", PageCollection.StrupPath, appName);

                    PageCollection.Message = "添加卸载目录";
                    Tool.CreateShortcut(programsPath + @"\四川橘子智税科技有限公司\卸载企助.lnk", PageCollection.StrupPath,
                    ...
                    Tool.CreateShortcut(desktopPath + @"\企助.lnk", PageCollection.StrupPath, appName); //创建快捷方式

                    PageCollection.Schedule = 100;
                    PageCollection.Plah = "100";
                    PageCollection.GridHide = 3;
                    PageCollection.Message = "企助安装完成";
                }
            }
            catch (Exception ex)
            {
